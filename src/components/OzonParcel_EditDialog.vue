...
<template>
  <div class="settings form-3">
    <h1 class="primary-heading">
      Заказ {{ item?.postingNumber ? item.postingNumber : '[без номера]' }}
    </h1>
    <hr class="hr" />
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <Field name="quantity" id="quantity" type="number" step="1" class="form-control input" :class="{ 'is-invalid': errors.quantity }" />
          </div>
          <div class="form-group">
