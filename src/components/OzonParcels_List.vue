...
const headers = computed(() => {
  return [
    ...
    { title: ozonRegisterColumnTitles.PostingNumber, key: "postingNumber", align: "start", width: "140px" },
    { title: ozonRegisterColumnTitles.PlacesCount, key: "placesCount", align: "start", width: "100px" },
    ...
    { title: ozonRegisterColumnTitles.WeightKg, key: "weightKg", align: "start", width: "80px" },
