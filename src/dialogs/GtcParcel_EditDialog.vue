...
const schema = Yup.object().shape({
  ...
  weight: Yup.number().nullable().min(0, 'Вес не может быть отрицательным'),
  quantity: Yup.number().nullable().min(0, 'Количество не может быть отрицательным'),
  cost: Yup.number().nullable().min(0, 'Цена не может быть отрицательной')
})
  ...
  <div class="settings form-4 form-compact">
    ...
    <hr class="hr" />
      ...
      <FeacnCodeEditor
        ...
        :columnTitles="gtcRegisterColumnTitles"
      ...
      <div class="form-section">
        <div class="form-row-1 product-name-row">
          <label for="productName" class="label-1 product-name-label">
            {{ gtcRegisterColumnTitles.productName }}:
          </label>
          <Field
            name="productName"
            id="productName"
      ...
      <div class="form-section">
        ...
        />
          ...
          <GtcFormField name="weight" type="number" step="1.0" :errors="errors" :fullWidth="false" />
          <GtcFormField name="quantity" type="number" step="1.0" :errors="errors" :fullWidth="false" />
          <GtcFormField name="cost" type="number" step="1.0" :errors="errors" :fullWidth="false" />
