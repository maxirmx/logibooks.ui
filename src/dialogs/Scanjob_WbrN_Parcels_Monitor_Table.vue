...
import { scanjobWbrNParcelHeaders } from '@/helpers/scanjob.monitor.helpers.js'

defineOptions({ name: 'Scanjob_WbrN_Parcels_Monitor_Table' })
...
<template>
  <ScanjobParcelsMonitorTable
    :headers="scanjobWbrNParcelHeaders"
    :parcels="parcels"
    :register="register"
    :loading="loading"
