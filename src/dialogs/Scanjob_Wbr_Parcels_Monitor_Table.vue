...
import { scanjobWbrParcelHeaders } from '@/helpers/scanjob.monitor.helpers.js'

defineOptions({ name: 'Scanjob_Wbr_Parcels_Monitor_Table' })
...
<template>
  <ScanjobParcelsMonitorTable
    :headers="scanjobWbrParcelHeaders"
    :parcels="parcels"
    :register="register"
    :loading="loading"
