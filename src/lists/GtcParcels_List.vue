...
//    { title: gtcRegisterColumnTitles.placesCount, key: 'placesCount', sortable: false, align: 'start', width: '120px' },
    { title: gtcRegisterColumnTitles.weight, key: 'weight', sortable: false, align: 'start', width: '100px' },
    { title: gtcRegisterColumnTitles.cost, key: 'cost', sortable: false, align: 'start', width: '100px' },
    ...
    { title: gtcRegisterColumnTitles.passportNumber, key: 'passportNumber', sortable: false, align: 'start', width: '120px' },
