...
const headers = computed(() => {
  ...
  const passportNumberColumn = {
    title: ozonRegisterColumnTitles.passportNumber,
    key: 'passportNumber',
    sortable: false,
    align: 'start',
    width: '120px'
  ...
  const importConsigneeColumns = [
    {
      title: ozonRegisterColumnTitles.inn,
      key: 'inn',
      sortable: false,
      align: 'start',
      width: '120px'
  ...
  const baseHeaders = [
    ...
    {
      title: ozonRegisterColumnTitles.postingNumber,
      key: 'postingNumber',
      align: 'start',
      width: '120px'
    },
    {
      title: ozonRegisterColumnTitles.checkStatus,
      key: 'checkStatus',
      align: 'start',
      width: '170px'
    },
    ...
    {
      title: ozonRegisterColumnTitles.productName,
      key: 'productName',
      sortable: false,
      align: 'start',
      width: '200px'
    ...
    {
      title: ozonRegisterColumnTitles.productLink,
      key: 'productLink',
      sortable: false,
      align: 'start',
      width: '150px'
    ...
    {
      title: ozonRegisterColumnTitles.article,
      key: 'article',
      sortable: false,
      align: 'start',
      width: '120px'
    ...
    {
      title: ozonRegisterColumnTitles.countryCode,
      key: 'countryCode',
      sortable: false,
      align: 'start',
      width: '100px'
    ...
    {
      title: ozonRegisterColumnTitles.weightKg,
      key: 'weightKg',
      sortable: false,
      align: 'start',
      width: '100px'
    ...
    {
      title: ozonRegisterColumnTitles.unitPrice,
      key: 'unitPrice',
      sortable: false,
      align: 'start',
      width: '100px'
    ...
    {
      title: ozonRegisterColumnTitles.currency,
      key: 'currency',
      sortable: false,
      align: 'start',
      width: '80px'
    ...
    {
      title: ozonRegisterColumnTitles.quantity,
      key: 'quantity',
      sortable: false,
      align: 'start',
      width: '80px'
    ...
    {
      title: ozonRegisterColumnTitles.lastName,
      key: 'lastName',
      sortable: false,
      align: 'start',
      width: '120px'
    ...
    {
      title: ozonRegisterColumnTitles.firstName,
      key: 'firstName',
      sortable: false,
      align: 'start',
      width: '120px'
    ...
    {
      title: ozonRegisterColumnTitles.patronymic,
      key: 'patronymic',
      sortable: false,
      align: 'start',
      width: '120px'
        ...
        <template #[`item.passport`]="{ item }">
          ...
          >
            <template #default>
              ...
              <span v-else>{{ formatPassport(item) }}</span>
            </template>
          </ClickableCell>
        </template>
