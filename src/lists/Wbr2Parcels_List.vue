...
const headers = computed(() => {
  ...
  const baseHeaders = [
    // Frozen order indicator - Always first for easy access
    ...
    {
      title: wbr2RegisterColumnTitles.shk,
      sortable: true,
      key: 'shk',
      align: 'start',
      width: '120px'
    ...
    {
      title: wbr2RegisterColumnTitles.checkStatus,
      key: 'checkStatus',
      align: 'start',
      width: '170px'
    },
    ...
    {
      title: wbr2RegisterColumnTitles.productLink,
      sortable: false,
      key: 'productLink',
      align: 'start',
      width: '150px'
    ...
    {
      title: wbr2RegisterColumnTitles.countryCode,
      sortable: false,
      key: 'countryCode',
      align: 'start',
      width: '100px'
    ...
    {
      title: wbr2RegisterColumnTitles.weightKg,
      sortable: false,
      key: 'weightKg',
      align: 'start',
      width: '100px'
    ...
    {
      title: wbr2RegisterColumnTitles.quantity,
      sortable: false,
      key: 'quantity',
      align: 'start',
      width: '80px'
    ...
    {
      title: wbr2RegisterColumnTitles.amountRub,
      sortable: false,
      key: 'amountRub',
      align: 'start',
      width: '100px'
    ...
    {
      title: wbr2RegisterColumnTitles.amount,
      sortable: false,
      key: 'amount',
      align: 'start',
      width: '100px'
    ...
    {
      title: wbr2RegisterColumnTitles.currency,
      sortable: false,
      key: 'currency',
      align: 'start',
      width: '80px'
    ...
    {
      title: wbr2RegisterColumnTitles.recipientName,
      sortable: false,
      key: 'recipientName',
      align: 'start',
      width: '200px'
    ...
    {
      title: wbr2RegisterColumnTitles.passportNumber,
      sortable: false,
      key: 'passportNumber',
      align: 'start',
      width: '120px'
