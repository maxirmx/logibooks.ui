...
const headers = computed(() => [
  ...
  {
    title: wbrnRegisterColumnTitles.stickerCode,
    key: 'stickerCode',
    align: 'start',
    sortable: false
  },
  ...
  { title: wbrnRegisterColumnTitles.weightKg, key: 'weightKg', align: 'start', sortable: false },
  { title: wbrnRegisterColumnTitles.quantity, key: 'quantity', align: 'start', sortable: false }
])
        ...
        <template #[`item.actions`]="{ item }">
          <div class="actions-container">
            <ActionButton
              ...
              :disabled="
                readOnly || runningAction || loading || !canClearParcelExtId(item, authStore)
              "
              v-if="isAdminUser"
            />
            <ActionButton
