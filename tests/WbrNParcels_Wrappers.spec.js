...
describe('WbrN parcel wrappers', () => {
  it('uses WbrN mapping and replacement recipient fields in the regular list', () => {
    ...
    expect(text).toContain("key: 'recipientLastName'")
    expect(text).toContain("key: 'recipientFirstName'")
    expect(text).toContain("key: 'recipientPatronymic'")
  ...
  it('uses WbrN mapping, article, and raw country in the edit dialog', () => {
    ...
    expect(text).toContain('name="recipientLastName"')
    expect(text).toContain('name="recipientFirstName"')
    expect(text).toContain('name="recipientPatronymic"')
