...
/**
 * Creates a localStorage mock that maintains state
 * Use this to mock localStorage in tests that need to test localStorage interaction
 * @returns {Object} A mock localStorage object with getItem, setItem, removeItem, and clear methods
 */
