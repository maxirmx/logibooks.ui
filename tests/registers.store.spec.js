...
describe('registers store', () => {
  ...
  describe('setDestinationField function', () => {
    ...
    it('sets destination to "in" when customsProcedureCode is missing', async () => {
  ...
  describe('ops functionality', () => {
    ...
    it('getTransportationDocument returns document for matching value', () => {
      ...
      store.ops.transportationTypes = [
        { value: 0, name: 'Авиационный', document: 'AWB', isAvia: true },
        { value: 1, name: 'Автодорожный', document: 'CMR', isAvia: false }
      ]
    ...
    it('isExportProcedure returns true for export', () => {
      const store = useRegistersStore()
